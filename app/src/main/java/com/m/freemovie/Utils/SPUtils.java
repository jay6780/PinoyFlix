...
public final class SPUtils {
    ...
    public void putStringList(@NonNull final String key, final List<String> value) {
        putStringList(key, value, false);
    }
    public void putStringList(@NonNull final String key, final List<String> value, final boolean isCommit) {
    ...
    public List<String> getStringList(@NonNull final String key, final List<String> defaultValue) {
