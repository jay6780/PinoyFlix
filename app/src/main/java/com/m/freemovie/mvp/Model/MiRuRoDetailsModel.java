...
public class MiRuRoDetailsModel {
    public static void getMiRuRoDetails(String url,final Callback<MiRuRoDetailBean> callback) {
        NetworkingUtils.getTagalogDub()
                .getMiRuRoDetails(url)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<MiRuRoDetailBean>() {
                    @Override
                    public void onSubscribe(Disposable d) {}

                    @Override
                    public void onNext(MiRuRoDetailBean data) {
