...
public class TagalogMovieFragment extends Fragment implements RevivalContractMovies.View {
    private FragmentTagalogServer2Binding binding;
    private TvRevivalAdapter tvRevivalAdapter;
    private RevivalMoviesPresenter revivalMoviesPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvRevivalAdapter.isMovie(true);
        binding.rvTagalog.setAdapter(tvRevivalAdapter);
        revivalMoviesPresenter = new RevivalMoviesPresenter(this);
        revivalMoviesPresenter.getMovieList(page);
