...
public class GiraffePlayer {
    ...
    private final View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.app_video_fullscreen) {
                if(listener==null){toggleFullScreen();}else {listener.onClick(v);}
    ...
    private void updatePausePlay() {
        if (videoView.isPlaying()) {
            $.id(R.id.app_video_play).image(R.drawable.stop);
        } else {
    ...
    public GiraffePlayer(final Activity activity, @Nullable View rootview) {
        try {
        ...
        if (mrootview == null) {
            ...
            videoView = (IjkVideoView) mrootview.findViewById(R.id.video_view);
        }
...
//                        Toaster.show("download rate:" + extra);
        ...
        if (mrootview == null) {
            ...
            seekBar = (SeekBar) mrootview.findViewById(R.id.app_video_seekBar);
        }
        ...
        if (mrootview == null) {
            ...
            View liveBox = mrootview.findViewById(R.id.app_video_box);
            liveBox.setClickable(true);
            liveBox.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (mrootview == null) {
            ...
            initHeight = mrootview.findViewById(R.id.app_video_box).getLayoutParams().height;
        }
    ...
    private void statusChange(int newStatus) {
        ...
        if (!isLive && newStatus == STATUS_COMPLETED) {
            ...
            hideAll();
            if (isLive) {
                showStatus(activity.getResources().getString(R.string.small_problem1));
